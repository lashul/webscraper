...
def index():
    if request.method == 'POST':
        ...
        second_date = request.form['last_date']
        ...
        s = driver.get(
            'https://plus.cq.com/login?fntoken&jumpto=https://plus.cq.com/schedules/other?1')
        driver.find_element("name", "username").send_keys(username)
        driver.find_element("name", "password").send_keys(password)
        driver.find_element(By.XPATH, "/html/body/div[2]/form/input").click()

        driver.find_element(
            By.XPATH, "/html/body/div[3]/div/div[2]/div/div/div/div/div/div/div/div[1]/div/div[1]/div/div/div[1]/select/option[2]").click()
        time.sleep(1)

        driver.find_element(
            By.XPATH, "/html/body/div[3]/div/div[2]/div/div/div/div/div/div/div/div[1]/div/div[1]/div/div/div[2]/input[1]").click()

        driver.find_element(
            By.XPATH, "/html/body/div[3]/div/div[2]/div/div/div/div/div/div/div/div[1]/div/div[1]/div/div/div[2]/input[1]").clear()

        calendar = driver.find_element(
            By.XPATH, "/html/body/div[3]/div/div[2]/div/div/div/div/div/div/div/div[1]/div/div[1]/div/div/div[1]/select/option[2]")
        action = ActionChains(driver)
        action.double_click(on_element=calendar)

        driver.find_element(
            By.XPATH, "/html/body/div[3]/div/div[2]/div/div/div/div/div/div/div/div[1]/div/div[1]/div/div/div[2]/input[1]").send_keys(first_date)

        driver.find_element(
            By.XPATH, "/html/body/div[3]/div/div[2]/div/div/div/div/div/div/div/h1").click()

        driver.find_element(
            By.XPATH, "/html/body/div[3]/div/div[2]/div/div/div/div/div/div/div/div[1]/div/div[1]/div/div/div[2]/input[2]").click()
        driver.find_element(
            By.XPATH, "/html/body/div[3]/div/div[2]/div/div/div/div/div/div/div/div[1]/div/div[1]/div/div/div[2]/input[2]").clear()
        driver.find_element(
            By.XPATH, "/html/body/div[3]/div/div[2]/div/div/div/div/div/div/div/div[1]/div/div[1]/div/div/div[2]/input[2]").send_keys(second_date)

        driver.find_element(
            By.XPATH, "/html/body/div[3]/div/div[2]/div/div/div/div/div/div/div/div[1]/div/div[3]/div/a[1]").click()
        time.sleep(5)
        ...
        with open(newsletter, 'w') as file:
            ...
            s = session.post(
                'https://plus.cq.com/login?fntoken&jumpto=https://plus.cq.com/schedules/other?1', data=login_data)
                ...
                for h in broth.findAll(True, {"class": ["sked-text-top"]}):
                    ...
                    if not "Not in Session" in h.text:
                        ...
                        for w in h2:
                            ...
                            if w == "Today" or w == "TODAY":
                                printme = printme+" at"
                        file.write("<p class=MsoNormal>"+printme +
                                   "</p")  # MsoNormal default word
                for y in broth.findAll(class_="text"):
                    if "https://" in y.get_text():
                        mih = y.get_text().split("//", 2)
                        # explaining to python the quote is text not a command
                        file.write("<p class=MsoNormal><a href=\"https://" +
                                   mih[1].rstrip() + "\">More information here</a>.</p>")
